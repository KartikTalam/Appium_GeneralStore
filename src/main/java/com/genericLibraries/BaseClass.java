...
public class BaseClass {
	...
	protected MobileGestures mobileGesture;

	@BeforeClass
	public void initialConfiguration() {
		mobileGesture = new MobileGestures();
	}
	...
	public void configuration() throws Exception {
		...
		options.setApp("C:\\Users\\Kartik\\eclipse-workspace\\Appium_GeneralStore\\src\\test\\resources\\General-Store.apk");
